...
export const fr: Partial<FooterPageCell> = {
  ...
  description: 'Comment ce site collecte, utilise et protège les données personnelles.',
  ...
  blocks: [
    ...
    { kind: 'p', text: "Une politique de confidentialité indique quelles données tu collectes, pourquoi, combien de temps tu les conserves, et comment un visiteur peut en demander la suppression." },
  ],
}
