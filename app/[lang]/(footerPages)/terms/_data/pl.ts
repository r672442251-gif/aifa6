...
export const pl: Partial<FooterPageCell> = {
  ...
  description: 'Zasady korzystania z tej strony i jej usług.',
  keywords: 'warunki korzystania z usługi, regulamin',
  blocks: [
    ...
    { kind: 'p', text: 'Warunki korzystania z usługi określają, co obiecujesz swoim odwiedzającym i czego od nich oczekujesz.' },
  ],
}
